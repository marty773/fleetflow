...
export default function AIIntervalGenerator({ vehicles, existingIntervals = [], records = [], open, onClose, onCreated }) {
  ...
  const [editingIndex, setEditingIndex] = useState(null); // index of interval being edited inline
  const [editDraft, setEditDraft] = useState(null); // draft values for inline edit
