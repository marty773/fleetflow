...
import { Wrench, FileText, Calendar, Truck, Menu, X, Package, DollarSign, Users, Settings, ArrowLeft, Upload } from 'lucide-react';
      ...
      >
        <div className="p-6">
          ...
          <nav className="space-y-2">
                    {[...navItems.slice(0, 4), { name: 'Vendors', path: 'Vendors', icon: Truck }, ...navItems.slice(4), { name: 'Settings', path: 'Settings', icon: Settings }, ...(currentUser?.role === 'admin' ? [{ name: 'Users', path: 'UserManagement', icon: Users }, { name: 'Fleet Export', path: 'FleetExport', icon: Upload }] : [])].filter(item => {
