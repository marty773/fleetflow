...
function LayoutContent({ children, currentPageName }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-950 dark:to-slate-900 flex">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed lg:relative w-64 bg-white dark:bg-slate-900 border-r border-slate-200 dark:border-slate-700 h-screen overflow-y-auto transition-all duration-300 z-50 ${
