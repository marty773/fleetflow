...
import ModuleExportPage from './pages/ModuleExport';
...
const AuthenticatedApp = () => {
  ...
  return (
    <Routes>
      ...
      <Route path="/ModuleExport" element={<LayoutWrapper currentPageName="ModuleExport"><ModuleExportPage /></LayoutWrapper>} />
